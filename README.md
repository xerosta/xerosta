...
- **Astro** for lightning-fast static sites (Zero-JS mindset)
- **Design Systems:** Tailwind CSS, Radix UI, Shadcn UI
- **State Management:** Zustand, Jotai
- **Build systems**: tsup, rollup, tsup

### Back-end
- **Frameworks:** Encore.ts, Elysia.js
- **Environments:** Node.js, Bun
- **Experimental / High-perf:** Rust back-ends for near-native speed & low memory
- **API & Architecture:** Monorepos, microservices, gRPC
...
## 📂 Projects
⚙️ *Working on some personal full-stack projects—stay tuned!*

## 📫 Connect with Me
- 🌐 Website: *under construction*
- ✉️ Email: *pro email soon*

## 🎷 Outside of Code
- 🥾 Avid hiker—exploring trails whenever I can
- 🎷 Saxophonist—jamming to smooth jazz in my free time

<br/> 

> ### “Code is like hiking: both are about the journey, the challenges, and the view at the end.”
